...
export const MovieManager = () => {
    ...
    return <div className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-9 max-md:col-span-10 max-lg:ml-4 max-lg:col-span-10 min-xl:col-span-9 pt-4 pr-7">
          <div className="w-full">
              ...
              <div className="bg-white px-4 py-6 mx-4 rounded-xl shadow-lg mt-10">
                  ...
                  <form className="space-y-2 max-lg:flex-col" onSubmit={(e) => handleSearchs(e)}>
                      ...
                      <div className="flex gap-2">
                          <button className="flex gap-1 items-center justify-center bg-rose-500 text-cyan-50 py-1 px-2 rounded-md" type="submit">
                              <svg className="h-5 text-center text-white white:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                          ...
                          >
                              <svg className="h-5 text-center text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              ...
              {/*Danh sách*/}
              <div className="w-full flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md mt-20 px-8 max-md:overflow-x-auto">
                      ...
                      <table className=" w-full min-w-[640px] table-auto min-xl:flex min-xl:flex-col lg:items-center max-lg:flex max-lg:flex-row">
                          <thead>
                              <tr className="text-left max-lg:flex max-lg:flex-col lg:w-1/4">
                                  ...
                                  <th className="py-3 px-5 border-b border-blue-gray-50 text-left">
                                      <button onClick={(e) => handleDeletelMovies(e)} className="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-red-700 border-0 border-gray-700 rounded hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-300 dark:hover:text-white mr-3">
                                          Xóa
                                      </button>
                                  </th>
                              </tr>
                          ...
                          {loading ? (
                              <tr className="col-span-6">
                                  <svg className="text-[40px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" style={{ shapeRendering: 'auto', display: 'block', background: 'rgb(255, 255, 255)' }}>
                                      <g>
                                          <g>
                                          ...
                                          <g transform="translate(-15 0)">
                                              <path transform="rotate(90 50 50)" fill="#56d4da" d="M50 50L20 50A30 30 0 0 0 80 50Z"></path>
                                  ...
                                  <tbody className="max-lg:grid max-lg:grid-cols-2 max-lg:gap-4 min-xl:grid min-xl:grid-cols-1 min-xl:gap-4">
                                  {
                                              ...
                                              <tr key={index} className="max-lg:w-3/4 max-lg:flex max-lg:flex-col min-xl:flex min-xl:flex-col">
                                                  ...
                                                  <td className="py-2 px-5 border-b border-blue-gray-50">
                                                      {movie.kindOfFilm.map((kind, index) => (
                                                          <div key={index} className="relative grid items-center font-sans uppercase select-none bg-gradient-to-tr from-cyan-500 to-cyan-300 text-white rounded-lg py-0.5 px-2 text-[11px] font-medium w-fit">
                                                              <span>{kind.name}</span>
                                                          </div>
                                                      ))}
                                                  </td>
                                                  ...
                                                  <td className="py-3 px-5 border-b border-blue-gray-50">
                                                      <input className="checkboxMovies" name="delete" value={movie.id} type="checkbox"/>
                                                  </td>
                                              </tr>
                                          )
                                      })
                      ...
                      <div>
                          <div className="flex flex-col items-center">
                              <div className="inline-flex mt-2 xs:mt-0">
                                  <button onClick={changePrev} className="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 rounded-s hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                  ...
                                  </button>
                                  {
                                      numbers.map((n, i) =>(
                                          <li className="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 border-0 border-s border-gray-700 rounded-e hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                                              key={i}>
                                              <a className='page-link' href="#" onClick={() => changeNPage(n-1)}>{n}</a>
                                          </li>
                                      ))
                                  }
                                  <button onClick={changeNext} className="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 border-0 border-s border-gray-700 rounded-e hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                      Next
