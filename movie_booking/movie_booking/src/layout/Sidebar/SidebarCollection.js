...
import { TicketIcon, EmployeeIcon, UserIcon, MovieIcon, PromotionIcon, RoomIcon, StatisticalIcon, LoginIcon, RegisterIcon } from "../../component/Booking/utils/Icons";
            ...
            <div className={`fixed xl:static z-50 bg-white shadow-sm border border-blue-gray-100 rounded-xl p-4 ${isOpen ? 'block' : 'hidden'} xl:block ${isOpen ? 'xl:hidden' : ''}`}>
                <div className="min-h-full">
                    ...
                    <ul className="mb-4 flex flex-col gap-1">
                        ...
                        <li className="tw-sidebar-item">
                            <a className="tw-sidebar-link" href="/movie_booking/movie_booking/public">
                                <StatisticalIcon />
